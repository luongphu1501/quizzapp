...
const TableUserPageginate = (props) => {
    const { pageCount, listUsers } = props;

    const handlePageClick = (event) => {
        props.displayListUserPageginate(+event.selected + 1)
        ...
        <>
            <table className="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    {
                        listUsers && listUsers.length === 0 && <tr><td colSpan={'4'}>Not Found</td></tr>
                    }
...
export default TableUserPageginate